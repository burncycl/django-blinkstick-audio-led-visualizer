...
# 2020/10 BuRnCycL
# This will install Packager Maintained Dependencies for django-blinkstick-audio-led-visualizer and facilitate non-root execution.
...
then
        ...
        $APT install -y python3 python3-pip python3-virtualenv virtualenv portaudio19-dev pulseaudio libatlas-base-dev redis-server screen
